...
public class ClienteDAOImpl implements ClienteDAO {
	...
	public int[][] batchInsertVehiculos(List<Vehiculo> vehiculos) {
		String sql = "INSERT INTO store.vehiculo "+
				"(c_vehiculo, s_marca, s_modelo, s_chassis, f_compra, b_estado, c_cliente) VALUE(?,?,?,?,?,?,?)";

		int [][] resultado = jdbcTemplate.batchUpdate(sql, vehiculos, 100, new ParameterizedPreparedStatementSetter<Vehiculo>() {
			@Override
